            ...
            <div class="content-wrap">
                <div class="container clearfix">
                    <ul id="portfolio-filter" class="clearfix">
                        ...
                        <li><a href="#" data-filter=".pf-bumn">BUMN</a></li>
                        <li><a href="#" data-filter=".pf-illustrations">Pemerintahan</a></li>
                        <li><a href="#" data-filter=".pf-uielements">Swasta</a></li>
                    </ul>

                    <div id="portfolio" class="clearfix">

                        <div class="portfolio-item pf-bumn">
                            <div class="portfolio-image">
                                <a href="#"><img src="<?= base_url() ?>assets/front_assets/images/portfolio/4/1.jpg" alt="Grey UI Kit" title="Grey UI Kit" /></a>
                        ...
                        <div class="portfolio-item pf-bumn">
                            <div class="portfolio-image">
                                <a href="#"><img src="<?= base_url() ?>assets/front_assets/images/portfolio/4/3.jpg" alt="Grey UI Kit" title="Grey UI Kit" /></a>
                                <div class="portfolio-overlay">
                                    <div class="portfolio-overlay-wrap">
                                        <p>Sed ut perspiciatis unde omnis iste natus voluptatem fringilla tempor dignissim at, pretium et arcu.</p>
                                        <span><span></span></span>
